...
// [ 0  1   0 ]
// [ sa 0  ca ]
void Camera::rotateY(float angle, const CPos &target)
{
	float xxx, zzz;
	float sinAng, cosAng;
...
*/
void Camera::pitch(float angle, const CPos &target)
{
...
void Camera::setTarget(const CPos &target)
{
